  ...
  useEffect(() => {
    ...
    if (!auth) {
      if (address !== undefined) {
        ...
        axios
          .post(`https://5000-imamabubaka-wxbaquizser-kt1qah62bvm.ws-eu78.gitpod.io/api/register`, formData)
          .then((res) => {
          ...
          axios
          .post(`https://5000-imamabubaka-wxbaquizser-kt1qah62bvm.ws-eu78.gitpod.io/api/login`, formData)
          .then((res) => {
            authenticate(res);
            })
          .catch((err) => {
